...
const openStartSection = () => {
  beynishStartSection.classList.add('hidden');
  startSection.classList.remove('hidden');
}

const openBeynishStartSection = () => {
  startSection.classList.add('hidden');
    ...
    "הישיבה הגבוהה בגמזו", "הישיבה הגבוהה בני נצרים", "הר ברכה", "הר המור", "הר עציון",
     "הר שלום – חומש", "חולון", "טפחות", "יפו – שירת משה", "ירוחם", "ישיבת הגולן – חיספין",
      "ישיבת ההסדר דימונה", "ישיבת ההסדר צפת", "ישיבת הכותל", "ישיבת המקדש", "ישיבת חומש המתחדשת",
       "ישיבת עלי – בני דוד", "ישיבת קשת", "ישיבת רמות", "כרם ביבנה", "לב לדעת – שדרות",
        "מחניים", "מכינת אבנר - עכו", "מכינת אורות", "מכינת איתן", "מכינת אלישע",
         "מכינת ארזי הלבנון", "מכינת בית יתיר", "מכינת בני דוד - עלי", "מכינת חוסן",
          "מכינת חמדת", "מכינת ידידיה", "מכינת יונתן", "מכינת לפידות - אמונה", "מכינת מגן שאול",
           "מכינת מעוז", "מכינת משכיות", "מכינת עז שלמה", "מכינת עטרת", "מכינת עצם (עצמונה)",
            "מכינת קשת יהודה", "מכינת רוח השדה", "מכינת שובו אחים", "מכינת תמיר", "מעלה אליהו",
             "מעלה אפרים", "מעלה גלבוע", "מעלות", "מצפה יריחו", "מצפה רמון", "מרכז הרב",
              "נהריה", "נווה דקלים", "נטע שורק", "ניר – קרית ארבע", "נצר מטעי – נצרים",
               "נצרת עילית", "נתיבות – אהבת ישראל", "נתיבות דרור – תלם", "נתיבות יוסף",
                "נתיבות ישראל – בת ים", "סוסיא", "עוז ואמונה", "עטרת ירושלים", "עטרת מרדכי",
                 "עטרת נחמיה", "עכו", "עתניאל", "צרור המור – בית שאן", "קרית גת", "קרית שמונה",
...
function validateForm(){
  let yeshiva = document.getElementById('autocomplete-input')
  let shioor = document.getElementById('shioor')

  if(yeshivot.includes(yeshiva.value) && shioor != "" && shioor != null){
    openConceptsSection();
  }
}
